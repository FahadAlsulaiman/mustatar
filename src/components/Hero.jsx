  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundImage: 'url(/hero/skyline.png)' }}
      />
      ...
      {/* Decorative geometric pattern strip on the left edge.
          `screen` blend drops the black background so only the gold lines show,
          letting the hero color fill the gaps. */}
      <div
        className="absolute inset-y-0 left-0 w-24 md:w-40 bg-repeat-y bg-top pointer-events-none opacity-25"
        style={{
          backgroundImage: 'url(/hero/pattern-strip.png)',
